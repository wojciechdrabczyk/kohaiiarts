...
export default function NavItem({ name, label, className = '' }: { name: string; label: string; className?: string }) {
    ...
    const inactive =
        ...
        'dark:border-[#c59d36] dark:text-[#c59d36] dark:hover:bg-white/5 dark:active:bg-white/8';

    const active =
        'border-[#822a59] bg-[#822a59] text-white ' + 'dark:border-[#c59d36] dark:bg-[#c59d36]/20 dark:text-[#c59d36] dark:hover:bg-[#c59d36]/20';
