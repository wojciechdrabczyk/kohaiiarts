        ...
        <div>
            <section className="bg-background relative w-full py-1 text-center antialiased sm:px-1 md:px-1 lg:px-1">
                ...
                <div className="mt-4 flex flex-col items-center gap-4 md:gap-6">
                    <h1
                        className="text-3xl font-light text-[#6e1f48] drop-shadow-[0_0_0.35rem_rgba(130,42,89,0.25)] transition-colors duration-300 md:text-6xl dark:text-[#deb34a] dark:drop-shadow-[0_0_0.35rem_rgba(222,179,74,0.35)]"
