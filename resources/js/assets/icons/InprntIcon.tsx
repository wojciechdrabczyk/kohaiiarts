type InprntIconProps = {
    size?: number;
    className?: string;
};

export default function InprntIcon({ size = 16, className = '' }: InprntIconProps) {
    return (
        <svg
