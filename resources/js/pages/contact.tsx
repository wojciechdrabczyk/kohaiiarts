    ...
    return (
        <div className="p-4 sm:px-6 md:px-10 mt-6">
            ...
            <form onSubmit={handleSubmit} className="mx-auto max-w-md space-y-6 px-2">
                {[{ id: 'name', label: 'Name', required: true }, { id: 'email', label: 'Email Address', required: true, type: 'email' }, { id: 'subject', label: 'Subject', required: false }].map(({ id, label, required, type }) => (
                    <div key={id} className="space-y-1">
                        ...
                        <input
                            ...
                            className={`w-full rounded border px-4 py-3 text-sm cursor-text ${
                                errors[id] ? 'border-red-600' : 'border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100'
                            }`}
                        />
                ...
                <div className="space-y-1">
                    ...
                    <textarea
                        ...
                        className={`w-full rounded border px-4 py-3 text-sm cursor-text ${
                            errors.message ? 'border-red-600' : 'border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100'
                        }`}
                    />
